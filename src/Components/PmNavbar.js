...
import EditProfile from "../Pages/PMs/EditProfile";
...
const Navbar = () => {
  ...
  async function fetchData() {
    const docRef = doc(db, 'pms', userPhone);
    ...
    <div className={classes.root}>
      <AppBar position="static" color="primary">
        <Toolbar>
          ...
          <NavLink to="/pm/students" className={classes.navLink} activeClassName={classes.active}>
            Students
          </NavLink>
          ...
          {/* <IconButton color="inherit">
           ...
           <div className={classes.avatarContainer} onClick={handleAvatarClick}>
            <Avatar src={user.imageUrl} sx={{marginRight:"10px"}} >{userLogo}</Avatar>
