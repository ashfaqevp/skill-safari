...
import { Box, Grid, Card,  Typography, Divider, TextField, InputAdornment, Avatar, useMediaQuery, Button, Fab, IconButton, DialogActions, CardActionArea, Menu, MenuItem} from '@mui/material';
...
const AllTrainers = () => {
  ...
  const handleDeleteConfirm = async () => {
    try {
        ...
        const studentRef = doc(db,  'trainers', trainerId);
  ...
  <DialogTitle sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
    ...
    <DialogContent>
    <EditTrainer handleSubmit={handleSubmit2} id={trainerId} />
    </DialogContent>
  </Dialog>
