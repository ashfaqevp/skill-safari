...
import { deleteDoc, collection, getDocs, query,  updateDoc, doc, onSnapshot} from "firebase/firestore";
...
function BatchStudents() {
    ...
    const getAllStudents = async () => {
      try {
        ...
        await Promise.all(batchSnapshot.docs.map(async (batchDoc) => {
    ...
    const handleEditClick = (student) => {
      navigate(`/admin/batch/${student.batchId}/student/${student.phone}`);
    };
        ...
        <CardContent className={classes.content}>
            ...
            <List>
              {students.map((student, index) => ( 
                <ListItem component={Link} to={`/admin/batch/${student.batchId}/student/${student.phone}`} key={student.phone}>
