...
const StudentProjects = () => {
  ...
  const fetchData = async () => {
    const docRef = doc(db, 'student', "+917894561230");
        ...
        <Grid item xs={12} sm={6}>
          <Paper sx={{ padding: 6 }}>
            <Grid container spacing={2}>
              ...
              <img src={student.imageUrl ? student.imageUrl : "https://via.placeholder.com/120x120"} alt="Profile" style={{ width: '20%', borderRadius: '50%' }} />
              </Box>
...
{student.twitter && (
  <Grid item xs={6} sm={2}>
    <Link href={student.twitter} target="_blank" rel="noopener noreferrer">
      <IconButton>
        <Twitter />
      </IconButton>
    </Link>
...
{student.telegram && (
  <Grid item xs={6} sm={2}>
    <Link href={student.telegram} target="_blank" rel="noopener noreferrer">
      <IconButton>
        <Telegram />
      </IconButton>
    </Link>
  ...
  <DialogTitle sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
    ...
    <DialogContent>
    <AddDetails handleSubmit={handleSubmit} />
    </DialogContent>
  </Dialog>
