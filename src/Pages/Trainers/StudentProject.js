...
const StudentProjects = () => {
  ...
  const getProjects = async () => {
    const projectsRef = collection(db, `batches/${id}/students/${std}/projects`);
  ...
  const handleDeleteConfirm = async () => {
    try {
        ...
        const studentRef = doc(db, `batches/${id}/students/${std}/projects/${projectId}`);
  ...
  return (
    <div className={classes.root}>
      ...
      <Box className={classes.batchBox}>
        ...
        <Typography variant="h6"><b>Projects ({projects.length})</b></Typography>
           ...
           <CardActionArea onClick={handleMenuOpen} sx={{ '&:hover': { backgroundColor: 'inherit' } }}>
              ...
              <CardContent>
                ...
                <Typography variant="body2">
                  <a href={project.githubLink} target="_blank" rel="noopener" color="inherit">
                    GitHub
                  </a>{" "}
                  |{" "}
                  <a href={project.liveUrl} target="_blank" rel="noopener" color="inherit">
                    Live
                  </a>
                </Typography>
              </CardContent>
  ...
  <DialogTitle sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
    ...
    <DialogContent>
    <AddProjects handleSubmit={handleSubmit} id={id} std={std} />
    </DialogContent>
  </Dialog>
